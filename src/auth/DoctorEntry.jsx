    ...
    <>
      <div className="flex flex-col md:flex-row ">
        ...
        <form method="post" className="basis-[50%] md:mt-10 mx-1">
          ...
          <fieldset>
            <label htmlFor="speciality" className="text-xl">Choose a Speciality:</label>

            <select name="expert" id="expert" className="w-full text-xl bg-white text-black p-2">
              <option value="cardiology" className="">Cardiology</option>
              <option value="dermatology" className="">Dermatology</option>
            </select>
          </fieldset>
          <fieldset>
      ...
      <button className="border w-full border-black bg-black text-white hover:bg-slate-300 hover:text-black mb-2 p-2">Submit</button>
        </form>
