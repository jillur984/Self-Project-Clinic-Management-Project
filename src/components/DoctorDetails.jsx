    ...
    <div className="container mx-auto w-full flex flex-col md:flex-row p-4">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center bg-gradient-to-r from-cyan-100 to-blue-200 p-6 rounded-lg shadow-md">
        ...
        <p className="text-gray-700 mb-1">
          Specialization: <span className="font-semibold">Family Medicine</span>
        </p>
        <p className="text-gray-700 mb-1">
          Experience: <span className="font-semibold">10 Years</span>
        </p>
        <p className="text-gray-700 mb-1">
          Location:{" "}
        ...
        <p className="text-gray-700 mb-4">
          Phone: <span className="font-semibold">+8801611780984</span>
        </p>

        <h2 className="font-bold text-lg mb-2">About Dr. Ali</h2>
        <p className="text-justify text-gray-600 mb-4">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Est ut totam
          officia dolor earum, alias quibusdam odio sed laborum ducimus
          voluptatem eaque nam unde? Accusantium atque rerum assumenda
          reiciendis nisi?
        </p>
