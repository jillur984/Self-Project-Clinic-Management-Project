    ...
    <>
      <section className="container mx-auto p-6 bg-white rounded shadow-md">
        ...
        <p className="text-center md:mx-24 mb-8 text-lg text-gray-600">
          ...
          registration form with your information, and a doctor will contact you
          shortly.
        </p>
        ...
        <form method="POST" className="space-y-6 w-full">
          ...
          {/* I will implement Age by Make function from DOB */}
          ...
          <div className="flex flex-col md:flex-row items-center w-full gap-4">
            ...
            <input
              ...
              name=""
              id=""
              className="w-full md:basis-[50%] space-x-4 p-3 "
